...
function DashboardContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div 
      className="h-screen w-screen flex items-center justify-center bg-cover bg-center bg-no-repeat p-12 md:p-16 xl:p-24 overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-[1400px] h-full max-h-[900px] items-center gap-6">
